...
const Login = () => {
  ...
  //!Error
  const errorMsg = userMutation?.error?.response?.data?.message;

  return (
    <div className="flex flex-wrap relative pl-20 h-[calc(100vh-64px)] max-sm:px-0">
      <div className="w-1/2 flex justify-center items-center relative max-sm:w-full">
        <img
          className="h-full w-full object-cover absolute z-[-1] top-0 left-0"
          src="https://images.unsplash.com/photo-1632516643720-e7f5d7d6ecc9?q=80&w=1911&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="signUp-image"
        />
        <h1 className="text-4xl font-extrabold text-white font-serif ml-5 w-1/2 max-lg:text-3xl max-md:text-2xl">
          Unlock your creative potential. Join Blogzy today!
        </h1>
      </div>
      <div className="w-1/2 p-4 max-sm:w-full">
        <div className="flex flex-col justify-center max-w-md mx-auto h-full">
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="w-full text-center pb-4">
              ...
              <a
                ...
                className="h-14 inline-flex items-center justify-center gap-2 py-4 px-6 my-6 rounded-xl bg-white w-full text-center border border-gray-100 shadow hover:bg-gray-50 focus:ring focus:ring-orange-200 transition duration-200"
                type="submit"
              >
                <svg
              ...
              <span className="text-lg font-medium text-zinc-600">Or</span>
            </div>
            <label
            ...
            <input
              className="w-full rounded-xl p-4 outline-none border border-gray-100 shadow placeholder-gray-500 focus:ring focus:ring-blue-200 transition duration-200 mb-2"
              type="text"
            ...
            <div className="flex items-center gap-1 w-full rounded-xl p-4 border border-gray-100 shadow mb-2">
              <input
            ...
            <button
              className="h-14 inline-flex items-center justify-center py-4 px-6 text-black font-bold font-heading rounded-xl bg-transparent w-full text-center border-2 border-blue-300 shadow hover:bg-sky-300 hover:border-none transition duration-300 mb-4"
              type="submit"
            >
              Login
            </button>
            <Link
              to="/register"
              className="inline-block w-full text-center text-gray-500 hover: transition duration-200"
            >
              <span>New to Blogzy? &nbsp;</span>
              <span className="font-bold font-heading text-sky-500">
                Register
              </span>
            </Link>
          </form>
