...
import { addCategoryAPI } from "../../services/categoryAPI";
        ...
        <div className="flex flex-col justify-center max-w-md mx-auto h-full py-12">
          <form onSubmit={formik.handleSubmit}>
            ...
            <input
              ...
              className="w-full rounded-full mt-4 p-4 outline-none border border-gray-100  shadow placeholder-gray-500 focus:ring focus:ring-orange-200 transition duration-200 mb-4"
