        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              <div className="pb-4">
                <div className="rounded-2xl w-14 h-14 flex items-center justify-center bg-green-500 ml-4 hover:scale-x-[-1] duration-300 ease-linear">
                  <FaDollarSign className="text-white" size="24" />
                </div>
              </div>
              <div className="relative pl-4 pb-12  flex-1">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              <div className="pb-4 lg:border-transparent">
                <div className="rounded-2xl w-14 h-14 flex items-center justify-center bg-red-600 ml-4 hover:scale-x-[-1] duration-300 ease-linear">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              <div className="pb-4">
                <div className="rounded-2xl w-14 h-14 flex items-center justify-center bg-blue-600 ml-4 hover:scale-x-[-1] duration-300 ease-linear">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              <div className="pb-4">
                <div className="rounded-2xl w-14 h-14 flex items-center justify-center bg-pink-500 ml-4 hover:scale-x-[-1] duration-300 ease-linear">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              <div className="pb-4">
                <div className="rounded-2xl w-14 h-14 flex items-center justify-center bg-yellow-500 ml-4 hover:scale-x-[-1] duration-300 ease-linear">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              <div className="pb-4">
                <div className="rounded-2xl w-14 h-14 flex items-center justify-center bg-purple-600 ml-4 hover:scale-x-[-1] duration-300 ease-linear">
